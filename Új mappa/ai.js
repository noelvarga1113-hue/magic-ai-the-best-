...
//
//  2.3: NAGYOBB, OKOSABB modellek (q4f32 – pontosabb, többnyelvű),
//  állítható RENDSZERNYELV (a válasz nyelve), és ENERGIATAKARÉKOS
//  mód (kevesebb token = kisebb gép- és energiaterhelés).
// ============================================================
...
(function () {
  ...
  // Egységes Qwen2.5 család, MOST a NAGYOBB PONTOSSÁGÚ q4f32 változatokkal: ezek több
  // nyelven (angol, orosz, portugál, német, spanyol, francia, olasz…) is pontosabbak,
  // és tökéletesebben írják le az idegen (pl. angol) szavakat is.
  var MODELS = [
    { id: "Qwen2.5-7B-Instruct-q4f32_1-MLC",   tier: "Expert", label: "Expert – a legokosabb (7B)",        mb: 5500 },
    { id: "Qwen2.5-3B-Instruct-q4f32_1-MLC",   tier: "Normal", label: "Normal – kiegyensúlyozott (3B)",     mb: 3000 },
    { id: "Qwen2.5-1.5B-Instruct-q4f32_1-MLC", tier: "Fast",   label: "Fast – gyors, gyengébb gépre (1.5B)", mb: 2000 }
  ];
  ...
  var DEFAULT_ID = "Qwen2.5-3B-Instruct-q4f32_1-MLC"; // alapértelmezett: Normal (jó egyensúly)
  ...
  function ecoOn() {
    try { return localStorage.getItem(LS_ECO) === "1"; } catch (e) { return false; }
  }
