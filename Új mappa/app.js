...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (seenVersion !== APP_VERSION) {
      ...
      addBotMessage(
        "🎉 **Üdvözlünk az új verzióban! Ez a Magic AI 2.0!** 🪄\n\n" +
        "Ezeket az újdonságokat adtuk most hozzá:\n" +
        "• 📸 **Extra funkciók sáv – okos Házi feladat megoldó!** A felső sávban a **📸 Házi feladat** gombbal lefényképezed a feladatot a telefon kamerájával, én pedig beolvasom (OCR), és **teljesen helyben, lépésről lépésre megoldom**: egyenletek, százalék, geometria, átlag, oszthatóság, sőt **fogalmazást is írok**! 🧮✍️\n" +
        "• 🧠 **1200+ tudástéma** – országok, fővárosok, pénznemek, a teljes periódusos rendszer, vármegyék, irodalom, történelem, feltalálók, bolygók, hegyek, folyók, az emberi test, matek- és fizikaalapok, tudósok, mitológia, nevezetességek, mértékegységek és még sok más!\n" +
        "• 📱 **Megújult mobilos felület** – a teljes design mostantól telefonon is tökéletesen működik és letölthető.\n" +
        "• 🧩 **Összetett kérdések**, 🎬 **YouTube-videók**, 🔄 **alkalmazáson belüli frissítés** – mind a helyén!\n\n" +
