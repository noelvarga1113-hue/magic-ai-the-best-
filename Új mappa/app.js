...
(function () {
  ...
  function addBotMessage(text, opts) {
    ...
    scrollToBottom();
    afterBotReply(text); // 🔊 felolvasás + 🌊 a tenger elsüllyesztése
    return row;
  }
  ...
  function handleSend() {
    ...
    setTimeout(function () {
      ...
      // Helyben nincs válasz: utánanézünk az interneten, több forrásban
      // (sorrend: magyar Wikipédia → angol Wikipédia → DuckDuckGo → friss cikkek)
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (seenVersion !== APP_VERSION) {
      ...
      addBotMessage(
        "🎉 **Üdvözlünk az új verzióban! Ez a Magic AI 1.2!** 🪄\n\n" +
        "Ezeket az újdonságokat adtuk most hozzá:\n" +
        "• 🔄 **Alkalmazáson belüli frissítés** – mostantól nem kell GitHubra menned: a ⚙️ Beállítások fülön egy gombbal megkeresem és letöltöm a legújabb verziót! Chatben is kérdezheted: „van új verzió?”\n" +
        "• 🧠 **1000+ tudástéma** – országok és fővárosok, pénznemek, a teljes periódusos rendszer, vármegyék, irodalom, történelem, feltalálók, bolygók, állati rekordok, sport és művészet!\n" +
        "• 🧩 **Összetett kérdések** – kérdezz akár többet egyszerre (pl. „Mi Franciaország fővárosa, és mennyi 25*4?”), részekre bontom, és mindegyikre határozott választ adok!\n" +
        "• 🎬 **YouTube-videók** – ha egy témáról videót is találok, a válasz alá teszem a linkjét!\n" +
        "• ✨ **Csúszó fülsáv** – a felső választósáv jelölője szépen, rugalmasan siklik át a fülek között.\n\n" +
